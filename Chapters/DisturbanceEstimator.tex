...
In steady-state where $k \rightarrow \infty$ we can assume that $\textbf{P}(k|k) = \textbf{P}(k-1|k-1) $. Furthermore the prediction covariance, the estimation covariance and the Kalman Gain approach a constant value:
\begin{equation}
