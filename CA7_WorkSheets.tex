...
\title{Modelling and Networked Control of Water Distribution Networks\\ Worksheets}
...
\newpage
\section{Graph Theoretical Analysis}\label{sec:GraphTheory}
...
\clearpage
\section{Optimal Control and the Linear-Quadratic Regulator}\label{sec:LQR}
\input{Chapters/LQR}

\clearpage
\section{Disturbance Estimator}\label{sec:KalmanFilter}
\input{Chapters/DisturbanceEstimator}

\clearpage
\section{Modelling Network Effects}\label{sec:PacketLoss}
\input{Chapters/PacketLoss}
